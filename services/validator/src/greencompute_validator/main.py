...
from greencompute_validator.config import settings as service_settings
from greencompute_validator.transport.routes import router

settings = load_runtime_settings("greencompute-validator")
