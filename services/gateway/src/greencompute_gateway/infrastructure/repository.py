...
from greencompute_persistence.orm import APIKeyORM, UserORM, UserSecretORM, WorkloadShareORM
from greencompute_protocol import APIKeyRecord, UserRecord, UserSecretRecord, WorkloadShareRecord
